...
<div class="blox-edit">
    ...
    <form action="?statistics-delete'.$pagehrefQuery.'" method="post">
        <table>
        <tr><td width="200">'.$terms['input'].'</td><td style="padding-top:7px; vertical-align:top"><input name="date" value="'.$pastDate.'" type="text" size="10" onclick="note.style.display=\'none\'" /><div id="note" class="smaller">'.$terms['older-than-a-year'].'</div></td></tr>
