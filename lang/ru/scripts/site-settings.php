...
'ignored-url-params' => [
    ...
    'note' => '<p>Имена параметров записывайте через запятую.</p><p>Нештатные  URL-параметры, например, параметры, добавляемые сервисами Яндекса, могут приводить к неправильной работе системы.</p><p>В частности, перестанут правильно работать блоки привязанные к URL страниц с помощью метода Tdd::bind().</p>',
],
